...
function rechercherVainqueur(pions, joueurs, tour)
{
     if (pions[0].innerHTML == joueurs[tour] &&
      ...
      {
        pions[0].style.backgroundColor = "#B2E0B2";
        pions[1].style.backgroundColor = "#B2E0B2";
        pions[2].style.backgroundColor = "#B2E0B2";
        return true;
      }
      /* Couleur des boutons */
      ...
      {
        pions[3].style.backgroundColor = "#B2E0B2";
        pions[4].style.backgroundColor = "#B2E0B2";
        pions[5].style.backgroundColor = "#B2E0B2";
        return true;
      }
      ...
      {
        pions[6].style.backgroundColor = "#B2E0B2";
        pions[7].style.backgroundColor = "#B2E0B2";
        pions[8].style.backgroundColor = "#B2E0B2";
        return true;
      }
...
/* Affichage du texte après les actions du joueur */
function main()
{
